...
export const PlotCard = ({ card, onUpdate, onDelete }: PlotCardProps) => {
  return (
    <div className="w-80 bg-gradient-to-br from-accent/5 to-accent/10 border border-accent/20 rounded-lg shadow-lg hover:shadow-xl transition-shadow p-4 group">
      ...
      <Textarea
        ...
        placeholder="Plot details, timeline, key events..."
        onClick={(e) => e.stopPropagation()}
      />
    </div>
  );
